...
<h3 align="center">As a Designer and Developer, my objective is to make a positive impact on clients and co-workers to make responsive websites. I have excellent knowledge of HTML, CSS, PHP,Laravel,JavaScript, Bootstrap, Jquery, WordPress theme design and customization Database, C programming, Photoshop, Illustrator and other necessary tools. I have 1+ years of experience creating and maintaining functional, attractive, and responsive websites. Highly experienced in Designing, Developing, blogging, and custom WordPress websites. I am a hardworking, self-motivated, enthusiastic individual as well as able to carry on a target-oriented job..</h3>
